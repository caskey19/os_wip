...
3. **One system, six lenses.** Overview, Academic, Tasks, Networking, Health, and Capital publish domain events into a shared event bus; the Calendar is the temporal projection of that data.

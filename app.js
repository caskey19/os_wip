...
["contacts", "links", "opportunities", "events", "health", "transactions", "subscriptions", "goals"].forEach(key => { if (!Array.isArray(systemData[key])) systemData[key] = structuredClone(systemSeed[key]); });
...
function switchView(view) {
  ...
  history.replaceState(null, "", ["academic", "networking", "calendar", "health", "capital", "settings"].includes(view) ? `#${view}` : location.pathname);
  closeSidebar();
}
...
function setupCapture() {
  ...
  $("#openCapture").addEventListener("click", () => {
    if (["networking", "calendar", "health", "capital"].includes(state.view)) {
...
function init() {
  ...
  switchView(["academic", "networking", "calendar", "health", "capital", "settings"].includes(requestedView) ? requestedView : "home");
}
